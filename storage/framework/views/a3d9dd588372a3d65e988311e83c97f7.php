                                ...
                                <tbody>
                                    <?php $__currentLoopData = $reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="border-b">
                                            ...
                                            <td class="py-3 px-4"><?php echo e($review->user->name); ?></td>
                                            <td class="py-3 px-4"><?php echo e($review->review); ?></td>
                                            <td class="py-3 px-4 text-yellow-500">
                                                <?php echo e(str_repeat('★', $review->rating)); ?>

                                                <?php echo e(str_repeat('☆', 5 - $review->rating)); ?>

                                            </td>
                                            <td class="py-3 px-4"><?php echo e($review->created_at->format('d M, Y')); ?></td>
                                            <td class="py-3 px-4">
                                                <!-- Delete Review -->
                                                <form action="<?php echo e(route('reviews.destroy', $review->id)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this review?');">
                                                    <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\User\Desktop\dewan\ccproj (3)\ccproj\resources\views/admin/review.blade.php ENDPATH**/ ?>