            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="<?php echo e(route('updatemenproduct', $product->id)); ?>" method="POST"  enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <form action="<?php echo e(route('destroymenproduct', $product->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="<?php echo e(route('storemenproduct')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="row">
...
</html><?php /**PATH D:\2nd Year\2nd semester\CC\CC\CC\ccproj\resources\views/admin/menproduct.blade.php ENDPATH**/ ?>