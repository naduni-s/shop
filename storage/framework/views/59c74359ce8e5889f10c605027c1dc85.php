    ...
    <?php $__currentLoopData = $womenproducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body text-center">
                    ...
                    <div class="d-flex justify-content-center">
                        <button class="btn btn-primary btn-sm me-3" data-toggle="modal" data-target="#editProductModal<?php echo e($product->id); ?>">Edit</button>
                        &nbsp;&nbsp;
                        <button class="btn btn-danger btn-sm me-3" data-toggle="modal" data-target="#deleteProductModal<?php echo e($product->id); ?>">Delete</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="<?php echo e(route('updatewomenproduct', $product->id)); ?>" method="POST"  enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PUT'); ?>
                            <div class="form-group">
                                <label for="productName">Product Name</label>
                                <input type="text" class="form-control" id="productName" name="name" value="<?php echo e($product->name); ?>" required>
                            </div>
                            <div class="form-group">
                                <label for="productName">Product Image</label>
                                <img src="<?php echo e(asset('storage/' . $product->image_url)); ?>" alt="<?php echo e($product->name); ?>" class="w-full h-20 object-contain mb-2" style="width: 300px; height: 300px;">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="productPrice" name="price" value="<?php echo e($product->price); ?>" required>
                            </div>
                            <div class="form-group">
                                <label for="productDescription">Description</label>
                                <textarea class="form-control" id="productDescription" name="description" required><?php echo e($product->description); ?></textarea>
                            </div>
        ...
        <div class="modal fade" id="deleteProductModal<?php echo e($product->id); ?>" tabindex="-1" role="dialog" aria-labelledby="deleteProductModalLabel<?php echo e($product->id); ?>" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="deleteProductModalLabel<?php echo e($product->id); ?>">Confirm Delete</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    ...
                    <div class="modal-footer">
                        <form action="<?php echo e(route('destroywomenproduct', $product->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="<?php echo e(route('storewomenproduct')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="row">
...
</html><?php /**PATH D:\2nd Year\2nd semester\CC\CC\CC\ccproj\resources\views/admin/womenproduct.blade.php ENDPATH**/ ?>