...
<?php $__env->startSection('title', 'For Women Page'); ?> 
<?php $__env->startSection('content'); ?>
    
    <div class="container mx-auto py-8 px-4">
        <div class="flex justify-between items-center">
        <div class="flex items-center space-x-2"> 
        <form method="GET" action="<?php echo e(route('filter.women')); ?>" class="flex items-center space-x-2">
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Desktop\dewan\ccproj (3)\ccproj\resources\views/forwomen.blade.php ENDPATH**/ ?>