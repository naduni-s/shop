...
<body class="bg-white font-sans">
    ...
    <div class="container mx-auto py-4 px-4 md:px-8">
        ...
        <div class="flex items-center justify-between mt-1 space-y-4 md:space-y-0 ml-10">
            ...
            <!-- Search Bar -->
            <form action="<?php echo e(route('search')); ?>" method="GET" class="search-bar flex items-center space-x-2 w-full md:w-auto mx-auto">
...
<div class="mobile-links md:hidden">
    <div class="relative block">
        <a href="<?php echo e(route('refilling_request.index')); ?>" class="text-sm font-medium text-white">My Requests</a>
    </div>
    <div class="relative block">
        <a href="<?php echo e(route('tracking')); ?>" class="text-sm font-medium text-white">Tracking</a>
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\ccp\ccproj\resources\views/layouts/layout.blade.php ENDPATH**/ ?>