                        ...
                        <tbody>
                            <?php $__currentLoopData = $subscriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $subscription): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($subscription->phone); ?></td>
                                    <td><?php echo e($subscription->address); ?></td>
                                    <td><?php echo e($subscription->gender); ?></td>
                                    <td><?php echo e($subscription->perfumes); ?></td>
                                    <td><?php echo e($subscription->notes ?? 'N/A'); ?></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                    </table>
...
</html><?php /**PATH C:\Users\User\Desktop\dewan\ccproj (3)\ccproj\resources\views/admin/subscription.blade.php ENDPATH**/ ?>