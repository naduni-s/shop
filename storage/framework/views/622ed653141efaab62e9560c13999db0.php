...
<?php endif; ?>
        <!-- Subscription Form -->
        <form id="subscription-form" action="<?php echo e(route('subscription.store')); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
            <div>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\2nd Year\2nd semester\CC\CC\CC\ccproj\resources\views/sub.blade.php ENDPATH**/ ?>