...
<td class="py-3 px-4">
                <form action="<?php echo e(route('updateDeliveryStatus', $request->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
                    <select name="delivery_status" class="form-control">
                        <option value="Pending" <?php echo e($request->delivery_status == 'Pending' ? 'selected' : ''); ?>>Pending</option>
                        <option value="Processing" <?php echo e($request->delivery_status == 'Processing' ? 'selected' : ''); ?>>Processing</option>
                        <option value="Shipped" <?php echo e($request->delivery_status == 'Shipped' ? 'selected' : ''); ?>>Shipped</option>
                        <option value="Delivered" <?php echo e($request->delivery_status == 'Delivered' ? 'selected' : ''); ?>>Delivered</option>
                        <option value="Cancelled" <?php echo e($request->delivery_status == 'Cancelled' ? 'selected' : ''); ?>>Cancelled</option>
                    </select>
...
<?php /**PATH D:\2nd Year\2nd semester\CC\CC\CC\ccproj\resources\views/delivery/refillorders.blade.php ENDPATH**/ ?>