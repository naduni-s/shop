    ...
    <div class="min-h-screen flex items-center justify-center px-6 py-12 fade-in">
        <div class="w-full sm:max-w-md glass-effect">
            <div class="flex justify-center mb-6">
                <a href="/">
                    <img src="<?php echo e(asset('scLogo.jpeg')); ?>" alt="Your Logo" class="h-16 w-auto">
                </a>
            </div>
...
<?php /**PATH C:\Users\User\Desktop\dewan\ccproj (3)\ccproj\resources\views/layouts/guest.blade.php ENDPATH**/ ?>