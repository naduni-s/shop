        ...
        <div class="md:w-1/2 p-6">
            ...
            <div class="flex items-center mb-6">
                ...
                <select id="size" name="size" class="p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-400">
                    ...
                    <option value="5ml" data-price="<?php echo e($product->price +1500); ?>">5ml - LKR <?php echo e(number_format($product->price +1500, 2)); ?></option>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ccp\ccproj\resources\views/detail.blade.php ENDPATH**/ ?>