...
<?php endif; ?>
                        ...
                        <div class="col-md-3 mb-4">
                            <div class="card shadow-sm">
                                <div class="card-body text-center">
                                    <h5 class="card-title"><?php echo e($decant->name); ?></h5>
                                    <p class="card-text text-success">Size: <?php echo e($decant->size); ?>ml</p>
                                    <p class="card-text text-success">Price: LKR <?php echo e($decant->price); ?></p>
                
                                    <div class="d-flex justify-content-center">
                                        <!-- Inline Edit Form -->
                                        <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#editDecantModal<?php echo e($decant->id); ?>">
                                            Edit
                                        </button>
                                        &nbsp;&nbsp;
                                        <!-- Delete Button -->
                                        <form action="<?php echo e(route('destroydecant', $decant->id)); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                ...
                <div class="modal fade" id="editDecantModal<?php echo e($decant->id); ?>" tabindex="-1" role="dialog" aria-labelledby="editDecantModalLabel<?php echo e($decant->id); ?>" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="editDecantModalLabel<?php echo e($decant->id); ?>">Edit Decant</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <form action="<?php echo e(route('updatedecant', $decant->id)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PUT'); ?>
                                <div class="modal-body">
                                    <div class="form-group">
                                        <label for="editDecantName">Decant Name</label>
                                        <input type="text" class="form-control" id="editDecantName" name="name" value="<?php echo e($decant->name); ?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="editDecantSize">Decant Size</label>
                                        <input type="text" class="form-control" id="editDecantSize" name="size" value="<?php echo e($decant->size); ?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="editDecantPrice">Decant Price</label>
                                        <input type="text" class="form-control" id="editDecantPrice" name="price" value="<?php echo e($decant->price); ?>" required>
                                    </div>
                                </div>
                ...
                <div class="modal fade" id="addDecantModal" tabindex="-1" role="dialog" aria-labelledby="addDecantModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="<?php echo e(route('storedecant')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <div class="form-group">
...
<?php /**PATH C:\Users\User\Desktop\dewan\ccproj (3)\ccproj\resources\views/admin/adddecant.blade.php ENDPATH**/ ?>