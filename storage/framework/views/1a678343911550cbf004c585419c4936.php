...
<?php endif; ?>
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <?php endif; ?>
            <a class="underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800 ms-3" href="<?php echo e(route('register')); ?>">
...
<?php endif; ?>
<?php /**PATH C:\Users\User\Desktop\dewan\ccproj (3)\ccproj\resources\views/auth/login.blade.php ENDPATH**/ ?>