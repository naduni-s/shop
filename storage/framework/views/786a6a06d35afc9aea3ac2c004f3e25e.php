...
<div class="min-h-screen flex flex-col items-center bg-gray-100 py-8">
    <div class="w-full max-w-6xl flex flex-col md:flex-row bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <div class="md:w-1/2 p-6">
            ...
            <p class="text-lg text-gray-700 mb-6"><?php echo e($product->description); ?></p>
            <p class="text-2xl font-semibold text-green-600 mb-6" id="product-price">LKR <?php echo e(number_format($product->price, 2)); ?></p>
            ...
            <div class="flex items-center mb-6">
                ...
                <select id="size" name="size" class="p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-400">
                    <option value="2ml" data-price="<?php echo e($product->price); ?>">2ml - LKR <?php echo e(number_format($product->price, 2)); ?></option>
                    <option value="5ml" data-price="<?php echo e($product->price +1000); ?>">5ml - LKR <?php echo e(number_format($product->price +1000, 2)); ?></option>
                    <option value="10ml" data-price="<?php echo e($product->price +2000); ?>">10ml - LKR <?php echo e(number_format($product->price +2000, 2)); ?></option>
                </select>
            </div>
            ...
            <button id="add-to-cart" 
                    ...
                    data-product-image="<?php echo e(asset('storage/' . $product->image_url)); ?>" 
...
<script>
    ...
    fetch("<?php echo e(route('addToCart')); ?>", {
        method: 'POST',
        headers: {
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\2nd Year\2nd semester\CC\CC\CC\ccproj\resources\views/detail.blade.php ENDPATH**/ ?>